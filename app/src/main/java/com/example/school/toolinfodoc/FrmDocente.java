...
public class FrmDocente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (tipoUsuario.equals("DOCENTE")){
            //new AsyncRepresentantes().execute(representante.getId());
        }else{
    ...
    private class AsyncDocentes extends AsyncTask<Object,Integer, Integer>{
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            if (values[0] == 1){
                spinnerAdapter = new SpinnerItemsArrayAdapter(FrmDocente.this,spinnerItems);
    ...
    private class AsyncMensajes extends AsyncTask<Object,Integer, Integer>{
        ...
        protected void onProgressUpdate(Integer... values) {
            if (values[0] == 1){
                adapter = new lvMensajesItemsArrayAdapter(FrmDocente.this,MensajesItems);
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            switch (values[0]){
                case 0:
                    ...
                    break;
                case 1:
                    lvCalendarioItemsArrayAdapter adapter = new lvCalendarioItemsArrayAdapter(FrmDocente.this,R.layout.lvcalendarioitemlayout,CalendarioItems);
    ...
    private void mostrarMensaje(Boolean enProgreso,int icono, String msj){
        if(enProgreso){
            ...
            dialogMessage = new CustomProgress(FrmDocente.this,enProgreso,icono,msj);
